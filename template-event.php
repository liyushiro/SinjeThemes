                    ...
                    <?php $events = imic_recur_events('future','',$event_category,'');
                            ...
                            <?php if(has_post_thumbnail($value)) { ?>
                                ...
                                <div class="grid-content">
                                    ...
                                    <span class="meta-data"><i class="fa fa-calendar"></i> <span class="event-date"><?php echo esc_attr(date_i18n(get_option('date_format'),$key)); ?></span><?php _e(' at ','framework'); ?><span class="event-time"><?php echo esc_attr(date_i18n(get_option('time_format'), $st_time)); ?></span></span>
