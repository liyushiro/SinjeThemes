function embedSelectedShortcode() {
	...
	if (current_shortcode != -1) {
		...
		var staff_cat = document.getElementById('staff-category').value;
		var staff_column = document.getElementById('staff-column').value;
		var staff_type = document.getElementById('staff-type').value;
		...
		if (shortcode_select == 'shortcode-staff') {
			shortcodeHTML = '<br/>[staff title="'+staff_title+'" number="'+staff_number+'" cat="'+staff_cat+'" column="'+staff_column+'" type="'+staff_type+'"]<br/>';	
		}
		...
		if (shortcode_select == 'shortcode-icons-box') {
			shortcodeHTML = '[icon_box icon_image="'+icon_box_image+'" line_icon="'+line_icon_box_image+'" title="'+icon_title+'" description="'+icon_description+'" link="'+icon_link+'"]';	
		}
