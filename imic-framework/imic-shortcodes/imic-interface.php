                    ...
                    <fieldset>
                        ...
                        <div class="option">
                            ...
                            <select id="shortcode-select" name="shortcode-select">
                                ...
                                <option value="shortcode-video"><?php _e('Video', 'imic-framework-admin'); ?></option>
                        ...
                        <?php $g_terms = get_terms('staff-category'); ?>
                            ...
                            <div class="option">
                                <label for="staff-type"><?php _e('Type', 'imic-framework-admin'); ?></label>
                            ...
                            <div class="option">
                                <label for="staff-column"><?php _e('Column', 'imic-framework-admin'); ?></label>
                                <select id="staff-column" name="staff-column">
                                    <option value="4"><?php _e('One Third', 'imic-framework-admin'); ?></option>
                                    <option value="3"><?php _e('One Fourth', 'imic-framework-admin'); ?></option>
                                    <option value="6"><?php _e('Half', 'imic-framework-admin'); ?></option>
                                    <option value="2"><?php _e('One Sixth', 'imic-framework-admin'); ?></option>
                                </select>
                            </div>
                        </div>
                        <!--//////////////////////////////
                        ...
                        <div id="shortcode-video">
                            <h5><?php _e('Video', 'imic-framework-admin'); ?></h5>
                            <div class="option">
                                <label for="video-url"><?php _e('Insert Vimeo or Youtube URL', 'imic-framework-admin'); ?></label>
                                <input id="video-url" name="video-url" type="text" value=""/>
                            </div>
                            <div class="option">
                                <label for="video-width"><?php _e('Video Width', 'imic-framework-admin'); ?></label>
                                <input id="video-width" name="video-width" type="text" value=""/>
                            </div>
                            <div class="option">
                                <label for="video-height"><?php _e('Video Height', 'imic-framework-admin'); ?></label>
                                <input id="video-height" name="video-height" type="text" value=""/>
                            </div>
                            <div class="option">
                                    <label for="video-full"><?php _e('Full Width', 'imic-framework-admin'); ?></label>
                        ...
                        <div id="shortcode-icons-box">
                            ...
                            <div class="option">
                                <label for="icon-box-image"><?php _e('Fonts Icon image', 'imic-framework-admin'); ?></label>
                                <input id="icon-box-image" name="icon-box-image" type="text" value="" style="visibility: hidden;"/>
                                <ul class="font-icon-grid"><?php echo $icon_list; ?></ul>
                            </div>
                            <div class="option">
                                <label for="line-icon-box-image"><?php _e('Icon image', 'imic-framework-admin'); ?></label>
                        ...
                        <div id="shortcode-typography">
                            ...
                            <div class="option">
                                ...
                                <select id="typography-type" name="typography-type">
                                    ...
                                    <option value="typo-container"><?php _e('Row', 'imic-framework-admin'); ?></option>
                            ...
                            <div id="typo-div">
                                <h5><?php _e('Div Tag', 'imic-framework-admin'); ?></h5>
                                <div class="option">
                                    <label for="div-xclass"><?php _e('Add Extra Class', 'imic-framework-admin'); ?></label>
                                    <input id="div-xclass" name="div-xclass" type="text" value=""/>
                                </div>
                            </div>
                            <div id="typo-spacer">
                                <h5><?php _e('Spacer Tag', 'imic-framework-admin'); ?></h5>
                                <div class="option">
                                    <label for="spacer-size"><?php _e('Select Spacer', 'imic-framework-admin'); ?></label>
                                    <select id="spacer-size" name="spacer-size">
                                        <option value="spacer-10"><?php _e('Spacer 10', 'imic-framework-admin'); ?></option>
                                        <option value="spacer-20"><?php _e('Spacer 20', 'imic-framework-admin'); ?></option>
                                        <option value="spacer-39"><?php _e('Spacer 30', 'imic-framework-admin'); ?></option>
                                ...
                                <div class="option">
                                    <label for="spacer-xclass"><?php _e('Add Extra Class', 'imic-framework-admin'); ?></label>
                        ...
                        <div id="shortcode-columns" class="shortcode-option">
                            ...
                            <div class="option">
                                ...
                                <select id="column-options" name="column-options">
                                    ...
                                    <option value=""><?php _e('Custom', 'imic-framework-admin'); ?></option>
                                </select>
                            </div>
                            <div class="option">
