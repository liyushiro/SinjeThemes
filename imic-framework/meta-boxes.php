...
$meta_boxes[] = array(
    ...
    'fields' => array(
		array(
			'name' => __( 'Sermon Speaker', 'meta-box' ),
...
$meta_boxes[] = array(
    ...
    'fields' => array(
           array(
			...
			'desc'  =>  __("Enter Sermon Categories ID's in which you would like to show them Ex-1,2,3.", 'framework'),
			'type' => 'text',
		),  
			array(
...
$meta_boxes[] = array(
    ...
    'fields' => array( 
	 //Address
		...
		array(
			'name' => __( 'Enable Registration', 'meta-box' ),
