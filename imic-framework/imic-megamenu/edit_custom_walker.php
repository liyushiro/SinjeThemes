    ...
    function start_el(&$output, $item, $depth = 0, $args = array(), $current_object_id = 0) {
        ...
        ?>
                ...
                <?php if ('custom' != $item->type && $original_title !== false) : ?>
                    ...
                    ?>"><?php _e('Remove', 'framework'); ?></a> <span class="meta-sep"> | </span> <a class="item-cancel submitcancel" id="cancel-<?php echo $item_id; ?>" href="<?php echo esc_url(add_query_arg(array('edit-menu-item' => $item_id, 'cancel' => time())), esc_url(remove_query_arg($removed_args, admin_url('nav-menus.php'))));
