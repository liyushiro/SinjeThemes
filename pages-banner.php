 ...
 ?>
        <div class="title-subtitle-holder">
            ...
            <?php if(get_post_type($id)=='event') {
				if($date!='') { ?>
    			<h2><?php echo date(get_option('date_format'),$date); ?></h2>
      			<div class="header-event-time"><?php _e('From ','framework'); echo esc_attr(date_i18n(get_option('time_format'),$event_time)); ?></span><?php echo __(' to ','framework'). esc_attr(date_i18n(get_option('time_format'),$event_end_time)); ?></div>
          	<?php } } else { ?>
